...
const images = [
  `${process.env.REACT_APP_BASE_PATH}home/logo/Component.png`,
  `${process.env.REACT_APP_BASE_PATH}home/logo/sideimgtwo.png`,
    `${process.env.REACT_APP_BASE_PATH}home/logo/img3.png`,
            ...
            <div className={styles.banner_header_left}>
              <div className={styles.sideimage_logo}>
                <img
                  ...
                  src={`${process.env.REACT_APP_BASE_PATH}home/logo/clubbed logo.png`}
                  alt="Event"
                />
              </div>
