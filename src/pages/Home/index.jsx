...
const images = [`${process.env.REACT_APP_BASE_PATH}home/logo/Component.png`, `${process.env.REACT_APP_BASE_PATH}home/logo/sideimgtwo.png`, `${process.env.REACT_APP_BASE_PATH}home/logo/img3.png`];
                ...
                <div className={styles.container}>
                    ...
                    <div className={styles.banner_header}>
                        ...
                        <div className={styles.sideimage}>
                            <img className={styles.event_image} src={images[currentIndex]} alt="Event Slideshow" />{" "}
                        </div>
                    </div>
                    ...
                    <div className={styles.banner_footer}>
                        <div>
                            <div className={styles.about_event}>
                                ...
                                <div>
                                    <p>
                                        Connect 1.0 by C3iHub, IIT Kanpur, is where cybersecurity and deep-tech converge. Over two action-packed days, the event brings together innovators, startups,
                                        industry leaders, investors, academics, and policymakers. Expect insightful talks, panel discussions, startup demos, product launches, and investor meetups, all
                                        aimed at driving collaboration and building solutions for national digital security. Whether you're a tech enthusiast or decision-maker, Connect 1.0 is your
                                        gateway to shaping the future of cybersecurity in India.
                                    </p>
                                </div>
                            </div>
                            <div>
